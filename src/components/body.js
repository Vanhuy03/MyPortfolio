const body = () =>{
    return`<section id="abouts" class="abouts">
    <div class="container">
        <div class="row">
            <div class="main_abouts_content">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="single_abouts wow fadeInLeft" data-wow-duration="1s">
                        ...
                        <p><span style ="color:red";>Name: </span>Nguyễn Văn Huy</p>
                        <p><span  style ="color:red">Birthday: </span>04/07/2003</p>
                        <p><span  style ="color:red">Email: </span>leohuy0387@gmail.com</p>
                        <p><span  style ="color:red">Phone: </span>(+84) 342365505</p>
                        <p><span  style ="color:red">Front-end Web Developer</span></p>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="main_business_content text-center wow fadeIn" data-wow-duration="2s">
                        <h2>CREATE YOUR OWN BUSINESS WITH MY IDEAS !</h2>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="head_title text-center wow zoomIn" data-wow-duration="0.5s">
                        ...
                        <div class="separetor"></div>
                        <p>We are here to help. Want to learn more about my services? Please get in touch, we'd love to hear from you!</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <!--<div class="col-lg-8 col-md-8 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">-->
                                     ...
                                     <div class="row">
                                      ...
                                      <div class="center-content">
                                        <input type="submit" value="CONTACT ME" class="btn btn-lg">
                                      </div>
                                    <!--</div>--> 
                            </form>
                        </div>
